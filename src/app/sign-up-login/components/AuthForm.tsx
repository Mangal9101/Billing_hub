    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-5/12 xl:w-1/2 bg-gradient-brand flex-col justify-between p-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-12">
            <AppLogo size={44} />
            <div>
              <p className="text-primary-foreground font-bold text-xl leading-tight">Billing Hub</p>
              <p className="text-primary-foreground/70 text-sm font-medium">BILL. MANAGE. GROW.</p>
            </div>
          </div>
        ...
        <div className="relative z-10"><p className="text-primary-foreground/50 text-xs">IST timezone · INR currency · Made for Indian retail</p></div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-10 lg:px-14 xl:px-20 py-10 bg-background overflow-y-auto">
        <div className="w-full max-w-md mx-auto">
          <div className="flex items-center gap-2 mb-8 lg:hidden"><AppLogo size={32} /><span className="font-bold text-foreground">Billing Hub</span></div>
...
function SignupPanel({ form, onSubmit, showPassword, setShowPassword, showConfirmPassword, setShowConfirmPassword, isLoading, googleLoading, onGoogleLogin }: any) {
  ...
  return <form onSubmit={onSubmit} className="space-y-4" noValidate>
    ...
    <GoogleButton loading={googleLoading} onClick={onGoogleLogin} />
    <div className="flex items-center gap-2"><div className="flex-1 h-px bg-border"/><span className="text-xs text-muted-foreground">or with email</span><div className="flex-1 h-px bg-border"/></div>
