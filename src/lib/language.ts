...
const translations: Record<string, string> = {
  // Navigation / groups
  'Dashboard': 'Dashboard',
  'Invoice & Billing': 'Invoice & बिलिंग',
  'Products': 'Products',
  'Customers': 'Customers',
  'Purchases': 'Purchases',
  'Stock Movements': 'Stock गतिविधियाँ',
  'Khatabook': 'Khatabook',
  'Staff': 'Staff',
  'Settings': 'Settings',
  'Overview': 'सारांश',
  ...
  'My Business': 'My बिज़नेस',
  'Account & App': 'Account और App',
  ...
  // Common actions
  'Add': 'Add करें',
  'Add Customer': 'Customer जोड़ें',
  'Add Product': 'Product जोड़ें',
  ...
  'Download Report': 'Report डाउनलोड करें',
  'Sign Out': 'साइन आउट',
  ...
  'Invoice': 'Invoice',
  'Invoices': 'इनवॉइस',
  'New Invoice': 'नया Invoice',
  'Invoice Number': 'Invoice नंबर',
  'Invoice Date': 'Invoice तारीख',
  'Product': 'Product',
  'Products': 'Products',
  'Qty': 'मात्रा',
  'Quantity': 'Quantity',
  ...
  'Customer Phone': 'Customer का Phone',
  'Customer Address': 'Customer का पता',
  'Select Customer': 'Customer चुनें',
  'Save Invoice': 'इनवॉइस सहेजें',
  ...
  'Low Stock Alert': 'Low Stock चेतावनी',
  'Low stock alert': 'कम स्टॉक चेतावनी',
  'Stock': 'स्टॉक',
  'Stock In': 'स्टॉक अंदर',
  'Stock Out': 'स्टॉक बाहर',
  'Purchase Price': 'Purchase मूल्य',
  'Wholesale Price': 'Wholesale मूल्य',
  'Retailer Price': 'Retailer मूल्य',
  'No products found': 'कोई प्रोडक्ट नहीं मिला',
  ...
  'You Will Get': 'आपको Get करना है',
  'You Will Give': 'आपको Give करना है',
  'You Gave': 'आपने दिए',
  'You Got': 'आपको मिले',
  'Collect Payment': 'Payment लें',
  ...
  'Amount': 'राशि',
  'Loading...': 'Loading...',
  'Please wait...': 'कृपया wait करें...',
  'Required': 'Required',
  'Optional': 'Optional',
  'Yes': 'हाँ',
  'No': 'नहीं',
  'Confirm': 'Confirm करें',
  'Error': 'Error',
  'Success': 'Success',
  'Failed': 'Failed',
